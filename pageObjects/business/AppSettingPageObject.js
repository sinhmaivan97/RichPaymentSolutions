...
exports.AppSettingPageObject = class AppSettingPageObject {
    constructor(page) {
        this.page = page;
        ...
        this.btn_app_setting = page.getByText('App Setting');
    ...
    async gotoAppPage(username, password) {
        ...
        await this.btn_app_setting.click();
    }
}